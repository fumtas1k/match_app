...
ActiveRecord::Schema.define(version: 2022_05_17_014507) do
  ...
  create_table "reactions", force: :cascade do |t|
    ...
    t.index ["to_user_id", "from_user_id"], name: "index_reactions_on_to_user_id_and_from_user_id", unique: true
